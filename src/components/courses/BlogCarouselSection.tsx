...
const BlogCarouselSection = ({ blogs, eyebrow = "Our Latest Blogs", title, subtitle }: BlogCarouselSectionProps) => {
  ...
  return (
    <section className="py-12 md:py-24 bg-background rounded-t-[3rem] md:rounded-t-[8rem]">
      <div className="container">
        <p className="text-center text-[10px] md:text-xs font-bold text-primary uppercase tracking-[0.2em] mb-2">{eyebrow}</p>
