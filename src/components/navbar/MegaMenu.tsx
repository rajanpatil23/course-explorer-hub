...
const MegaMenu = () => {
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {open && (
        <div className="fixed left-1/2 -translate-x-1/2 top-16 w-[calc(100%-3rem)] max-w-7xl bg-card border border-border rounded-b-xl shadow-2xl z-40 flex max-h-[75vh]">
          {/* Col 1 — Categories */}
