...
const timeline = [
  { year: "2018", desc: "Founded with project management training, a focused curriculum, and a small expert network.", position: "top" as const },
  { year: "2020", desc: "Expanded reach to international learners, growing our professional community across countries.", position: "bottom" as const },
  { year: "2022", desc: "Launched corporate training programs, partnering with leading organizations to upskill teams.", position: "top" as const },
  { year: "2024", desc: "Crossed major learner milestones, deepened partnerships with global accreditation institutes.", position: "bottom" as const },
  { year: "2026", desc: "Redefining professional education through bold innovation and our learner-first philosophy.", position: "top" as const },
];
