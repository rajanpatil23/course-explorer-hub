    ...
    <section className="py-16 md:py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="relative min-h-[420px] md:min-h-[520px] flex items-center justify-center">
          ...
          {/* Central canvas card */}
          <div className="relative w-[85%] max-w-md md:max-w-lg rounded-2xl shadow-2xl border-4 border-primary-foreground/15 bg-card overflow-hidden">
            {/* Slide content */}
            <div className="relative p-8 md:p-12 min-h-[280px] md:min-h-[320px] flex flex-col items-center justify-center text-center">
              ...
              <div
                key={`icon-${active}`}
                className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mb-5 animate-fade-in-up"
              >
                {slide.icon}
              </div>
              ...
              <span
                key={`label-${active}`}
                className="text-[10px] md:text-xs font-bold text-primary uppercase tracking-[0.2em] mb-2 animate-fade-in-up"
              >
                {slide.label}
              </span>
              ...
              <h3
                key={`title-${active}`}
                className="font-heading text-xl md:text-2xl font-bold text-foreground mb-3 md:mb-4 animate-fade-in-up"
              >
                {slide.title}
              </h3>
              ...
              <p
                key={`body-${active}`}
                className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-sm animate-fade-in-up"
              >
                {slide.body}
              </p>
            </div>
