    ...
    <section ref={ref} className="relative z-20 -mt-14 md:-mt-24 mb-12 md:mb-24">
      <div className="container">
        <div className="relative max-w-5xl mx-auto border border-primary/30 rounded-2xl bg-primary px-4 py-6 md:px-10 md:py-10 shadow-lg overflow-hidden">
          ...
          <div className="absolute top-6 right-16 w-5 h-[2px] bg-primary-foreground/10 rotate-45 z-0" />
          <div className="absolute bottom-4 left-14 w-8 h-[2px] bg-primary-foreground/15 -rotate-45 z-0" />
          <div className="absolute bottom-7 left-10 w-5 h-[2px] bg-primary-foreground/10 -rotate-45 z-0" />
          {/* Soft glow */}
