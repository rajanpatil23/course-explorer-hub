...
// SAFe course details — updated with official Scaled Agile Partner Kit content
const safeDetails: Record<string, Partial<Course>> = {
  "SAFE-LSA": {
    subtitle: "Give your leaders the operating system for business agility, upgraded for the AI era",
    heroHighlights: [
      "16 hours of AI-Empowered Leading SAFe training",
      "Lead Lean-Agile transformation with SAFe mindset, values & principles",
      "Practical AI prompting techniques integrated throughout",
      "SAFe Agilist (SA) certification exam included",
    ],
    secretSauce: [
      { title: "AI-Empowered Curriculum", icon: "cpu" },
      { title: "PI Planning Simulation", icon: "calendar" },
      { title: "Certification Exam Included", icon: "award" },
      { title: "1-Year SAFe Insider Access", icon: "globe" },
    ],
    courseHighlights: [
      { text: "16 Hours of AI-Empowered Leading SAFe® Training", bold: "16 Hours" },
      { text: "Lead Lean-Agile Transformation at Enterprise Scale", bold: "Lean-Agile Transformation" },
      { text: "Align Strategic Objectives & Improve Value Flow", bold: "Strategic Objectives" },
      { text: "Establish Team & Technical Agility", bold: "Technical Agility" },
      { text: "Practical, Responsible AI Prompting Techniques", bold: "AI Prompting" },
      { text: "SAFe Agilist (SA) Certification Exam", bold: "SA Certification" },
    ],
    aboutCourse: "This newly enhanced course equips leaders to drive Lean-Agile transformation, align complex organizations around clear objectives, and accelerate value delivery using practical AI prompting techniques built into the curriculum. Leaders learn how to apply SAFe mindset, values, and principles to lead a Lean-Agile enterprise, while building AI fundamentals and role-specific prompting techniques that act as an accelerant of value.",
    benefits: [
      "Shared Language Across Leadership — Leaders align on the same principles, operating model, and approach to business agility",
      "Clearer Alignment & Stronger Value Flow — Teams move from traditional hierarchy to organizing around the flow of value",
      "AI Readiness for Leadership Work — Learn how AI can enhance your leadership role, integrated throughout the course",
      "Faster Time-to-Market — Business agility supports leaders in delivering higher-quality solutions at speed",
    ],
    demand: {
    ...
    curriculum: [
      { title: "Thriving in the Digital Age with Business Agility", topics: ["Business Agility", "SAFe as an Operating System", "Lean-Agile Mindset"] },
      { title: "Building a Foundation with Mindset, Values and Principles", topics: ["Lean-Agile Leadership", "SAFe Core Values", "SAFe Principles"] },
      ...
      { title: "Exploring Lean Portfolio Management", topics: ["Portfolio Vision", "Strategic Themes", "Lean Budgets"] },
      { title: "Leading the Change", topics: ["Leading by Example", "Organizational Change", "Creating the Implementation Plan"] },
    ],
    prerequisites: ["No prerequisites required — all are welcome to attend the course"],
    includes: [
      "Live instructor-led training",
      "Digital course workbook and materials",
      "One-year access to SAFe Insider (SAFe Framework, SAFe CoPilot, SAFe Connect Forums)",
      "Opportunity to earn SAFe Agilist (SA) certification, renewed yearly",
      "Practical AI prompting techniques integrated into curriculum",
  ...
  "SAFE-SP": {
    subtitle: "Build confidence to thrive in a high-performing Agile team empowered by AI",
    heroHighlights: [
      "16 hours of AI-Empowered SAFe for Teams training",
      "Execute Iterations and participate in PI Planning",
      "Practical, responsible AI prompting techniques",
      "SAFe Practitioner (SP) certification exam included",
    ],
    secretSauce: [
      { title: "AI-Empowered Curriculum", icon: "cpu" },
      { title: "ART Coordination Skills", icon: "users" },
      { title: "Certification Exam Included", icon: "award" },
      { title: "1-Year SAFe Insider Access", icon: "globe" },
    ],
    courseHighlights: [
      { text: "16 Hours of AI-Empowered SAFe for Teams Training", bold: "16 Hours" },
      { text: "Apply Lean-Agile Principles for Meaningful Results", bold: "Lean-Agile Principles" },
      { text: "Execute Iterations & PI Planning Effectively", bold: "Iterations & PI Planning" },
      { text: "Coordinate Across the Agile Release Train", bold: "ART Coordination" },
      { text: "Practical, Responsible AI Prompting Techniques", bold: "AI Prompting" },
      { text: "SAFe Practitioner (SP) Certification Exam", bold: "SP Certification" },
    ],
    aboutCourse: "Build your confidence to work effectively within an Agile Release Train (ART). This course gives you the essential skills to thrive in a high-performing team — from executing Iterations to participating in PI Planning. Now upgraded with responsible AI practices, this training equips you with modern tools to streamline your daily tasks and solve complex problems faster.",
    benefits: [
      "Team Effectiveness — Gain essential skills to thrive in a high-performing Agile team",
      "ART Coordination — Learn to coordinate across teams to deliver value within the organizational structure",
      "AI-Ready Skills — Integrate responsible AI tools to streamline workflows and solve complex problems faster",
      "SAFe+ Benefits — Access SAFe Skills, selected workshops, knowledge articles, and community forums",
    ],
    demand: {
      jobOpenings: "SAFe Practitioner roles growing across enterprises",
      roles: [
        { title: "SAFe Practitioner", salaryMin: "$80K", salaryAvg: "$105K", salaryMax: "$135K" },
        { title: "Agile Team Member", salaryMin: "$75K", salaryAvg: "$100K", salaryMax: "$130K" },
      ],
      hiringCompanies: ["TCS", "Infosys", "Wipro", "Cognizant"],
      growthPercent: "25%",
      growthDescription: "growth in SAFe Practitioner roles annually",
    },
    curriculum: [
      { title: "Introducing SAFe", topics: ["SAFe Overview", "Lean-Agile Mindset", "SAFe Principles"] },
      { title: "Forming Agile Teams as an Agile Release Train", topics: ["ART Organization", "Team Formation", "Roles & Responsibilities"] },
      { title: "Connecting to the Customer", topics: ["Customer Centricity", "Design Thinking", "User Stories"] },
      { title: "Planning the Work", topics: ["Iteration Planning", "PI Planning Participation", "Backlog Management"] },
      { title: "Continuously Delivering Value", topics: ["Iteration Execution", "Built-In Quality", "Continuous Integration"] },
      { title: "Getting Feedback & Improving Relentlessly", topics: ["Iteration Review", "Retrospectives", "Continuous Improvement"] },
    ],
    prerequisites: ["No prerequisite required — all are welcome to attend"],
    includes: [
      "Live instructor-led training",
      "Digital course workbook and materials",
      "One-year access to SAFe Insider (SAFe Framework, SAFe CoPilot, SAFe Connect Forums)",
      "Opportunity to earn SAFe Practitioner (SP) certification, renewed yearly",
      "Eligible for 15 PDUs (PMI) and SEUs (Scrum Alliance)",
      "Practical AI prompting techniques integrated into curriculum",
    ],
    contactHours: "16",
    rating: "4.7",
  ...
  "SAFE-POPM": {
    ...
    heroHighlights: [
      "16 hours of AI-Empowered SAFe POPM training",
      "Master backlog ownership, forecasting & PI Planning",
    ...
    courseHighlights: [
      { text: "16 Hours of AI-Empowered SAFe POPM Training", bold: "16 Hours" },
      { text: "Master PO/PM Role & Responsibilities in SAFe", bold: "PO/PM Role" },
      { text: "Lead and Support PI Planning Effectively", bold: "PI Planning" },
      { text: "Agile Product Delivery & Customer Centricity", bold: "Product Delivery" },
      { text: "AI Skills for Modern Product Roles", bold: "AI Skills" },
      { text: "POPM Certification Exam Included", bold: "POPM Exam" },
    ],
    aboutCourse: "In this two-day certification course, learn to effectively perform the Product Owner/Product Manager (POPM) role in the Agile Release Train (ART). Gain skills to break down Epics into Features and Stories, manage backlogs, leverage AI, plan and execute Iterations and Planning Intervals, and use the Continuous Delivery Pipeline for improvement.",
    benefits: [
      "Product Focus — Master day-to-day responsibilities including backlog ownership, forecasting, and managing risks",
      "PI Planning Leadership — Understand how to prepare for and lead PI planning, aligning vision with business goals",
      "Customer Centricity — Use lean-agile thinking to define, prioritize, and deliver features and stories quickly",
      "AI-Enhanced Product Skills — Learn practical, responsible AI techniques for backlog refinement, prioritization, and feature discovery",
    ],
    demand: {
    ...
    curriculum: [
      { title: "Becoming a PO/PM in the SAFe Enterprise", topics: ["PO vs PM Responsibilities", "Collaboration Models", "SAFe Context"] },
      { title: "Preparing for and Leading PI Planning", topics: ["Vision & Roadmap", "Feature Writing", "PI Objectives"] },
      { title: "Executing Iterations", topics: ["Iteration Execution", "Backlog Refinement", "Accepting Stories"] },
      { title: "Executing the Planning Interval", topics: ["Customer Feedback", "Value Metrics", "Continuous Exploration"] },
      { title: "AI Skills for Modern Product Roles", topics: ["Responsible AI Practices", "AI for Backlog Refinement", "AI-Enhanced Decision Making"] },
    ],
    prerequisites: ["All are welcome; Leading SAFe® course highly recommended", "Experience working in a SAFe environment recommended", "Experience with Lean, Agile, or relevant certifications helpful"],
    includes: [
      "Live instructor-led training",
      "Digital course workbook and materials",
      "One-year access to SAFe Insider (SAFe Framework, SAFe CoPilot, SAFe Connect Forums)",
      "Opportunity to earn SAFe POPM certification, renewed yearly",
      "AI skills for modern product roles",
      "Post-training mentor access",
    ],
    contactHours: "16",
  ...
  "SAFE-SPC": {
    ...
    heroHighlights: [
      "32 hours of AI-Empowered Implementing SAFe training",
      "Identify value streams, launch Agile Release Trains",
      "Apply AI in practical, role-specific ways",
      "SAFe Practice Consultant (SPC) certification exam included",
    ],
    secretSauce: [
      { title: "AI-Empowered Curriculum", icon: "cpu" },
      { title: "ART Launch Simulation", icon: "rocket" },
      { title: "Certification Exam Included", icon: "award" },
      { title: "Teach SAFe Courses", icon: "book-open" },
    ],
    courseHighlights: [
      { text: "32 Hours of AI-Empowered Implementing SAFe® Training", bold: "32 Hours" },
      { text: "Guide Enterprise Change Through Coaching & Leadership", bold: "Enterprise Change" },
      { text: "Optimize Organizational Flow with Value Streams & ARTs", bold: "Organizational Flow" },
      { text: "Advance Product Delivery with Agile Product Management", bold: "Product Delivery" },
      { text: "Practical, Responsible AI Prompting Techniques", bold: "AI Prompting" },
      { text: "SPC Certification — Authorized to Deliver SAFe Courses", bold: "SPC Certification" },
    ],
    aboutCourse: "To lead organizational change at scale, change agents must master the core principles of the SAFe Framework while leveraging the transformative potential of AI. This course equips you with the verified skills to coach, teach, and guide successful transformations as a SAFe Practice Consultant (SPC). You will learn to identify value streams, launch Agile Release Trains, and apply AI-driven insights to accelerate value delivery.",
    benefits: [
      "Stronger Transformation Leadership — Plan and guide SAFe implementation efforts through hands-on leadership, coaching, and facilitation",
      "Improved Execution Alignment — Develop skills to identify value streams, support ART launches, and strengthen flow from strategy to delivery",
      "Modern, Responsible AI Application — Gain practical understanding of how AI can enhance your role while maintaining responsible practices",
      "Sustainable Internal Expertise — Building certified SPCs reduces reliance on external support and strengthens long-term transformation resilience",
    ],
    demand: {
    ...
    curriculum: [
      { title: "Adapting and Thriving with SAFe", topics: ["Business Agility", "Digital Age Challenges", "SAFe as an Operating System"] },
      { title: "Building a Foundation with Mindset, Values and Principles", topics: ["Lean-Agile Mindset", "SAFe Core Values", "SAFe Principles"] },
      { title: "Team and Technical Agility", topics: ["Agile Teams", "Built-In Quality", "Team Topologies"] },
      { title: "Agile Product Delivery", topics: ["Customer Centricity", "PI Planning", "DevOps & Release on Demand"] },
      { title: "Lean Portfolio Management", topics: ["Portfolio Vision", "Strategic Themes", "Lean Budgets & Guardrails"] },
      { title: "Leading the Change", topics: ["Leading by Example", "Change Management", "Creating the Implementation Plan"] },
      { title: "Reaching the SAFe Tipping Point", topics: ["Implementation Strategy", "Training Plan", "Organizational Readiness"] },
      { title: "Designing the Implementation", topics: ["Value Stream Identification", "ART Design", "Preparing for ART Launch"] },
      { title: "Launching the Agile Release Train", topics: ["ART Kickoff", "PI Planning Preparation", "Executing PI Planning"] },
      { title: "Coaching ART Execution", topics: ["Iteration Execution", "System Demo", "Inspect & Adapt"] },
      { title: "Enhancing the Portfolio & Accelerating Business Agility", topics: ["Portfolio Flow", "Large Solution", "Continuous Improvement"] },
    ],
    prerequisites: ["All are welcome; SAFe for Teams (SP) and Leading SAFe (SA) highly recommended", "Experience as Agile Coach, RTE, or Transformation Lead helpful"],
    includes: [
      "Live instructor-led training",
      "Digital course workbook and materials",
      "One-year access to SAFe Insider (SAFe Framework, SAFe CoPilot, SAFe Connect Forums)",
      "Eligibility to earn SAFe Practice Consultant (SPC) certification",
      "Authorization to teach SAFe courses upon certification",
      "AI-enhanced coaching and transformation techniques",
    ],
    contactHours: "32",
    rating: "4.8",
    reviewCount: "1,100",
  ...
  "SAFE-RTE": {
    ...
    heroHighlights: [
      "24 hours of AI-Empowered SAFe RTE training",
      "Lead Agile Release Trains and facilitate PI Planning",
      "AI-powered tools for risk identification & problem-solving",
    ...
    secretSauce: [
      ...
      { title: "Certification Exam Included", icon: "award" },
      { title: "ART Coaching Skills", icon: "users" },
    ],
    courseHighlights: [
      { text: "24 Hours of AI-Empowered RTE Training", bold: "24 Hours" },
      { text: "Lead the Agile Release Train (ART)", bold: "Lead ART" },
      { text: "Optimize the Flow of Value Across Teams", bold: "Flow of Value" },
      { text: "Accelerate ART Coaching & Relentless Improvement", bold: "ART Coaching" },
      { text: "Practical, Responsible AI Prompting Techniques", bold: "AI Prompting" },
      { text: "RTE Certification Exam Included", bold: "RTE Exam" },
    ],
    aboutCourse: "In this three-day certification course, you will learn the skills to be an effective, AI-Empowered SAFe Release Train Engineer (RTE) in a SAFe enterprise. We cover how to lead Agile Release Trains (ARTs), facilitate events, and coach teams for continuous improvement. You will also explore how to leverage AI as a work accelerant, using new skills in prompting and pattern recognition to enhance risk identification and problem-solving.",
    benefits: [
      "ART Leadership — Facilitate key SAFe events, especially PI Planning, to align all teams on a shared mission",
      "Value Flow Optimization — Manage risks and dependencies, foster cross-team collaboration, and remove organizational impediments",
      "AI-Accelerated Coaching — Use AI-powered tools to identify performance patterns, dependencies, and risks you might otherwise miss",
      "Responsible AI Integration — Accelerate complex problem-solving, analyze data, and enhance coaching impact with practical AI techniques",
    ],
    demand: {
    ...
    curriculum: [
      { title: "Exploring the RTE Role", topics: ["RTE in SAFe", "Servant Leadership", "ART Organization"] },
      { title: "Applying SAFe Principles", topics: ["Lean-Agile Mindset", "Flow Principles", "PI Cadence"] },
      { title: "Facilitating PI Planning", topics: ["PI Planning Readiness", "PI Planning Facilitation", "Management Review & Problem-Solving"] },
      { title: "Executing the PI", topics: ["Iteration Execution", "System Demo", "ART Sync"] },
      { title: "Improving ART Performance", topics: ["Inspect & Adapt", "Value Stream Mapping", "Metrics & Reporting"] },
      { title: "AI-Accelerated RTE Practices", topics: ["AI for Risk Identification", "Pattern Recognition", "Responsible AI Principles"] },
    ],
    prerequisites: ["Leading SAFe or SAFe Scrum Master recommended", "Experience in a SAFe environment", "Understanding of Agile Release Train concepts"],
    includes: [
      "Live instructor-led training",
      "Digital course workbook and materials",
      "One-year access to SAFe Insider (SAFe Framework, SAFe CoPilot, SAFe Connect Forums)",
      "Opportunity to earn SAFe RTE certification, renewed yearly",
      "AI-powered risk identification and coaching techniques",
      "Post-training mentor access",
    ],
    contactHours: "24",
    rating: "4.7",
...
export const categories: Category[] = [
  ...
  },
  {
    ...
    courses: [
      enrichCourse({ name: "AI-Empowered Leading SAFe® (SAFe Agilist – SA)", code: "SAFE-LSA", duration: "2 Days | 16 Hrs", level: "Intermediate", skills: ["Lean-Agile Mindset", "SAFe Principles", "PI Planning"], learners: "9K+", badge: "Popular", category: "SAFe® Agile" }),
      ...
      enrichCourse({ name: "AI-Empowered SAFe® for Teams (SAFe Practitioner – SP)", code: "SAFE-SP", duration: "2 Days | 16 Hrs", level: "Beginner", skills: ["Lean-Agile Principles", "Iteration Execution", "ART Coordination"], learners: "5K+", badge: "Trending", category: "SAFe® Agile" }),
      enrichCourse({ name: "AI-Empowered SAFe® Product Owner/Product Manager (POPM)", code: "SAFE-POPM", duration: "2 Days | 16 Hrs", level: "Intermediate", skills: ["Product Backlog", "PI Objectives", "Customer Centricity"], learners: "6K+", badge: "Trending", category: "SAFe® Agile" }),
      enrichCourse({ name: "AI-Empowered Implementing SAFe® with SPC Certification", code: "SAFE-SPC", duration: "4 Days | 32 Hrs", level: "Expert", skills: ["ART Launch", "Value Stream Mapping", "SAFe Implementation"], learners: "3K+", badge: "Advance", category: "SAFe® Agile" }),
      enrichCourse({ name: "AI-Empowered SAFe® Release Train Engineer (RTE)", code: "SAFE-RTE", duration: "3 Days | 24 Hrs", level: "Expert", skills: ["ART Coordination", "Program Execution", "Inspect & Adapt"], learners: "2K+", badge: "Advance", category: "SAFe® Agile" }),
